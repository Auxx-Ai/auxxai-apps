// src/blocks/notion/shared/use-notion-data.ts

/**
 * Module-level cache + React hook for loading Notion data (databases, properties, users).
 *
 * Uses composite cache keys that include parent dependencies (e.g., `properties:${dbId}`)
