// src/tools/internal/carrier-get-many.tool.tsx

import { defineTool, z } from '@auxx/sdk/tools'
import shipstationIcon from '../../assets/icon.png'
import carrierGetManyExecute from './carrier-get-many.tool.server'

/**
 * ShipStation carrier getMany (block-internal).
 *
 ...
 */
export const carrierGetManyTool = defineTool({
  id: 'block_shipstation_carrier_get_many',
  name: 'ShipStation carrier getMany (block-internal)',
