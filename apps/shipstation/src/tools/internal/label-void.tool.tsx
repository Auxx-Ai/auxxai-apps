// src/tools/internal/label-void.tool.tsx

import { defineTool, z } from '@auxx/sdk/tools'
import shipstationIcon from '../../assets/icon.png'
import labelVoidExecute from './label-void.tool.server'

/**
 * Requests a carrier refund for a label. Approval is not guaranteed.
 *
 ...
 */
export const labelVoidTool = defineTool({
  id: 'block_shipstation_label_void',
  name: 'ShipStation label void (block-internal)',
