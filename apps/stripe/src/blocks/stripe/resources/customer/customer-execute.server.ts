// src/blocks/stripe/resources/customer/customer-execute.server.ts
...
export async function customerCreate(input: Record<string, any>): Promise<Record<string, any>> {
...
export async function customerDelete(input: Record<string, any>): Promise<Record<string, any>> {
  const apiKey = getApiKey()
...
export async function customerGet(input: Record<string, any>): Promise<Record<string, any>> {
  const apiKey = getApiKey()
...
export async function customerGetMany(input: Record<string, any>): Promise<Record<string, any>> {
  const apiKey = getApiKey()
...
export async function customerUpdate(input: Record<string, any>): Promise<Record<string, any>> {
  const apiKey = getApiKey()
