...
export const createQuickbooksInvoiceInputs = z.object({
  customerId: z.string().describe('QuickBooks Customer.Id. Resolve via find_quickbooks_customer.'),
  lines: z
    .array(
      z.object({
...
export const createQuickbooksInvoiceTool = defineTool({
  ...
  icon: quickbooksIcon,
  inputs: createQuickbooksInvoiceInputs,
  outputs: z.object({
    invoiceId: z.string(),
