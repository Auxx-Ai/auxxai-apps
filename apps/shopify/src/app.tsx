...
import { listShopifyPayoutTransactionsTool } from './tools/list-shopify-payout-transactions.tool'
import { listShopifyPayoutsTool } from './tools/list-shopify-payouts.tool'
...
export const app = {
  ...
  // Data connectors — sync external records into the entity system. One connector
  // per app, many streams (customer/order/product); see ./shopify.connector.ts.
  dataConnectors: [shopifyConnector],
  tools: [
    // Agent-facing tools
    ...
    // Platform-facing tools: called by id from the platform's settlement job, no agent surface.
    listShopifyPayoutsTool,
    listShopifyPayoutTransactionsTool,
